...
import type { SetImageRows } from '../types/shared.ts';
import ImagePopup from "./ImagePopup.tsx"; // adjust the path accordingly
    ...
    return (
        <div className="flex items-center justify-center h-full relative">
            ...
            <div className="flex flex-col items-center justify-center mr-2">
                {/* Image number */}
                <span className="text-xs text-gray-500 mb-1">{`#${imageNumber}`}</span>

                {/* Hide button */}
                <button
                    onClick={() => hideImage(imageId, onRowsChange)}
